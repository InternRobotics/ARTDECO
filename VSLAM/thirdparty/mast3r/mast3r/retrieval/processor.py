...
from VSLAM.thirdparty.mast3r.mast3r.retrieval.model import RetrievalModel, extract_local_features
...
class Retriever(object):
    ...
    def __init__(self, modelname, backbone=None, device='cuda'):
        ...
        # 1.1 初始化类
        # freeze_backbone=1, hdims='', residual=0, featweights='l2norm', prewhiten=0, postwhiten=None,
        # nfeat=300.0, nclusters='64k', imsize=512, pretrained='finalmast3r',
